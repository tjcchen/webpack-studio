...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_" + {"7":"2ecde8fd"}[chunkId] + ".js"
/******/ 	}
/******/
...
/* harmony import */ var _react_less__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27);
...
/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(28);
...
/* harmony import */ var _assets_images_webpack_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(359);
...
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
 ...
 // add to test webpack-bundle-analyzer plugin
...
var ReactFooter = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ReactFooter, [{
    ...
    value: function loadComponent() {
      ...
      __webpack_require__.e(/* import() */ 7).then(__webpack_require__.bind(null, 365)).then(function (Text) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        src: _assets_images_webpack_svg__WEBPACK_IMPORTED_MODULE_5__["default"],
        width: "200px",
        height: "120px",
...
$Symbol[PROTOTYPE][TO_PRIMITIVE] || __webpack_require__(37)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf); // 19.4.3.5 Symbol.prototype[@@toStringTag]
...
var document = __webpack_require__(31).document; // typeof document.createElement is 'object' in old IE
...
var cof = __webpack_require__(62); // eslint-disable-next-line no-prototype-builtins
...
var $export = __webpack_require__(35); // 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
...
var $export = __webpack_require__(35); // 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)


$export($export.S + $export.F * !__webpack_require__(33), 'Object', {
...
var $export = __webpack_require__(35); // 19.1.2.3 / 15.2.3.7 Object.defineProperties(O, Properties)


$export($export.S + $export.F * !__webpack_require__(33), 'Object', {
  defineProperties: __webpack_require__(75)
});
...
var TAG = __webpack_require__(54)('toStringTag'); // ES3 wrong here
...
if (!(HAS_INSTANCE in FunctionProto)) __webpack_require__(38).f(FunctionProto, HAS_INSTANCE, {
  value: function (O) {
...
var $parseFloat = __webpack_require__(113); // 18.2.4 parseFloat(string)
...
if (!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')) {
  ...
  for (var keys = __webpack_require__(33) ? gOPN(Base) : ( // ES3:
...
var $parseFloat = __webpack_require__(113); // 20.1.2.12 Number.parseFloat(string)
...
var $at = __webpack_require__(155)(true); // 21.1.3.27 String.prototype[@@iterator]()
...
var defined = __webpack_require__(63); // true  -> String#at
...
__webpack_require__(37)(IteratorPrototype, __webpack_require__(54)('iterator'), function () {
  return this;
});
...
var toISOString = __webpack_require__(184); // PhantomJS / old WebKit has a broken implementations
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(37)(proto, TO_PRIMITIVE, __webpack_require__(187));
...
$export($export.S + $export.F * !__webpack_require__(194)(function (iter) {
  Array.from(iter);
}), 'Array', {
...
var createProperty = __webpack_require__(192); // WebKit Array.of isn't generic
...
$export($export.P, 'Array', {
  copyWithin: __webpack_require__(214)
});
...
var toIObject = __webpack_require__(60); // 22.1.3.4 Array.prototype.entries()
...
if (__webpack_require__(33) && (!CORRECT_NEW || __webpack_require__(34)(function () {
  re2[__webpack_require__(54)('match')] = false; // RegExp constructor can alter flags and IsRegExp works correct with @@match
...
var regExpExec = __webpack_require__(232); // @@match logic


__webpack_require__(233)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
...
var at = __webpack_require__(155)(true); // `AdvanceStringIndex` abstract operation
...
__webpack_require__(233)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
...
var regExpExec = __webpack_require__(232); // @@search logic


__webpack_require__(233)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
...
var callRegExpExec = __webpack_require__(232);
...
__webpack_require__(233)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  var internalSplit;
...
Wrapper = __webpack_require__(36)[PROMISE]; // statics
...
var $WeakMap = module.exports = __webpack_require__(251)(WEAK_MAP, wrapper, methods, weak, true, true); // IE11 WeakMap frozen keys fix
...
var rConstruct = (__webpack_require__(31).Reflect || {}).construct; // MS Edge supports only 2 arguments and argumentsList argument is optional
...
var toPrimitive = __webpack_require__(43); // MS Edge has broken Reflect.defineProperty - throwing instead of returning false
...
var userAgent = __webpack_require__(245); // https://github.com/zloirock/core-js/issues/280
...
var $defineProperty = __webpack_require__(38); // B.2.2.2 Object.prototype.__defineGetter__(P, getter)


__webpack_require__(33) && $export($export.P + __webpack_require__(304), 'Object', {
...
module.exports = __webpack_require__(49) || !__webpack_require__(34)(function () {
...
var $defineProperty = __webpack_require__(38); // B.2.2.3 Object.prototype.__defineSetter__(P, setter)
...
var getOwnPropertyDescriptor = __webpack_require__(79).f; // B.2.2.4 Object.prototype.__lookupGetter__(P)
...
var getOwnPropertyDescriptor = __webpack_require__(79).f; // B.2.2.5 Object.prototype.__lookupSetter__(P)
...
$export($export.P + $export.R, 'Map', {
  toJSON: __webpack_require__(309)('Map')
});
...
$export($export.P + $export.R, 'Set', {
  toJSON: __webpack_require__(309)('Set')
});
